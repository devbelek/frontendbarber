...
export const barbers: Barber[] = [
  {
    ...
    description:
      "Специалист по классическим мужским стрижкам с опытом более 7 лет. Создаю стильные, практичные образы для современных мужчин.",
  },
  {
    id: "2",
    ...
    description:
      "Мастер современных стрижек с вниманием к деталям. Специализируюсь на сложных фейдах и текстурных стрижках.",
  },
  {
    id: "3",
    name: "Руслан Доскеев",
    ...
    description:
      "Создаю трендовые молодежные стрижки. Люблю экспериментировать и находить уникальный стиль для каждого клиента.",
  },
];
