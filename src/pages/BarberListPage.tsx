      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          ...
          <div className="text-sm text-gray-600 mb-4">
            {regionFilter === 'current' ? (
              <p>
                Регион: <span className="font-medium">{currentRegion.name}</span>
            ...
            {searchQuery && (
              <p className="mt-1">
                Результаты поиска по запросу: <span className="font-medium">"{searchQuery}"</span>
              </p>
            )}
            <p className="mt-1 font-medium">
              Найдено: {filteredBarbers.length} {filteredBarbers.length === 1 ? 'барбер' : 'барберов'}
            </p>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="bg-gray-50 p-8 rounded-lg text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">Барберы не найдены</h3>
